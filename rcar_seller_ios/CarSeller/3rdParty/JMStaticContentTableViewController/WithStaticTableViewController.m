//
//  WithStaticTableViewController.m
//  CarSeller
//
...
#import "WithStaticTableViewController.h"
#import <QuartzCore/QuartzCore.h>

@interface WithStaticTableViewController ()

@end

@implementation WithStaticTableViewController
...
- (CGFloat)tableView:(UITableView *)tableView heightForHeaderInSection:(NSInteger)section {
    JMStaticContentTableViewSection *sectionContent = [self.staticContentSections objectAtIndex:section];
    if (sectionContent.title != nil && sectionContent.sectionHeaderHight == 0.f)
        return 30.f;
    else
        return sectionContent.sectionHeaderHight;
}
- (CGFloat)tableView:(UITableView *)tableView heightForFooterInSection:(NSInteger)section {
    JMStaticContentTableViewSection *sectionContent = [self.staticContentSections objectAtIndex:section];
    return sectionContent.sectionFooterHeight;
}
...
- (UIView *)tableView:(UITableView *)tableView viewForHeaderInSection:(NSInteger)section {
    ...
    UIView *view = [[UITableViewHeaderFooterView alloc]initWithReuseIdentifier:@"UITableViewHeader"];
    if (sectionContent.headerView != nil)
        [view addSubview:sectionContent.headerView];
    return view;
}
- (UIView *)tableView:(UITableView *)tableView viewForFooterInSection:(NSInteger)section {
    JMStaticContentTableViewSection *sectionContent = [self.staticContentSections objectAtIndex:section];
    
    UIView *view = [[UITableViewHeaderFooterView alloc]initWithReuseIdentifier:@"UITableViewFooter"];
    if (sectionContent.footerView != nil)
        [view addSubview:sectionContent.footerView];
    return view;
}
...
- (UITableViewCell *) tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    UITableViewCell *cell = [self.tableView dequeueReusableCellWithIdentifier:cellContent.reuseIdentifier];
...
- (void)tableView:(UITableView *)tableView willDisplayCell:(UITableViewCell *)cell forRowAtIndexPath:(NSIndexPath *)indexPath {
    JMStaticContentTableViewSection *sectionContent = [self.staticContentSections objectAtIndex:indexPath.section];
    if (indexPath.section == self.staticContentSections.count - 1 &&
        indexPath.row == sectionContent.staticContentCells.count - 1) {
...
- (void) tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    if(!self.tableView.editing && !self.tableView.allowsMultipleSelection) [self.tableView deselectRowAtIndexPath:indexPath animated:YES];
    if(self.tableView.editing && !self.tableView.allowsMultipleSelectionDuringEditing) [self.tableView deselectRowAtIndexPath:indexPath animated:YES];
